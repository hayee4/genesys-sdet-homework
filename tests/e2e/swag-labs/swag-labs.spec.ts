...
test.describe('Swag Labs Test Suite', () => {
    ...
    test('Should complete end-to-end purchase flow with two items @swag-labs @e2e', async ({ page }) => {
    ...
    test('Should validate login error messages and footer information @swag-labs @e2e', async ({ page }) => {
